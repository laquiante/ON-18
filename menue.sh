...
echo "*                                                                                                    *"
echo "*                                (new, OCT-23) #10 ONIE/APT                                          *"
echo "*                                (new, NOV-23) #11 Challenge lab layer 2                             *"
echo "*                                (new, NOV-23) #12 Challenge lab layer 3                             *"
echo "*                                (new, NOV-23) #13 Packet Generator (mz)                             *"
echo "*                                (new, NOV-23) #14 Performance Validation (iperf, iperf3, nuttcp)    *"
echo "*                                                                                                    *"
